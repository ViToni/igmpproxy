...
**  lib.c
**
**  Some formatting functions for in_addr and utility functions.
**----------------------------------------------------------------------------*/
...
/**
**  Converts an IP address in u_long (network) format into a printable string.
**/
...
/**
**  Converts an IP subnet number in u_long (network) format into a printable
